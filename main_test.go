...
func TestHandler(t *testing.T) {
	...
	//the second argument is the route (which we leave blank for now, and will get back to soon), and 
	//the third is the request body, which we don't have in this case.
...
func TestRouterGet(t *testing.T) {
	...
	if b == nil {
		t.Errorf("Responsebody shouldn't be nil")
	}
}